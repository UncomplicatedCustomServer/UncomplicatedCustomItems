...
namespace UncomplicatedCustomItems.API.Features.SpecificData
{
    ...
    public class KeycardData : Data, IKeycardData
    {
        ...
        public string TintColor { get; set; } = "#FFD700";
        ...
        public string PermissionsColor { get; set; } = "#FFD700";
        ...
        public string SerialNumber { get; set; } = "123456789012";
        ...
        public string LabelColor { get; set; } = "#FFD700";
